...
- [DSH-SessionManager](https://github.com/BISTU-guheihei/DSH-SessionManager) — Session management tool for DeepSeek Harness: trash-based delete (recoverable), archive/unarchive, session stats, cache cleanup. Dark whale-girl themed GUI + full CLI. Prebuilt Windows exe & Linux ELF.
